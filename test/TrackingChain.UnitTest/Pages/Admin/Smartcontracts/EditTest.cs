...
#pragma warning restore CA1001 // Not need in unit test
    {
        ...
        public async Task OnPostShoudleEditSmartContractAsync()
        {
            ...
            Assert.Equal("{\"ByteWeight\":210,\"GetTrackSelectorValue\":null,\"InsertTrackSelectorValue\":null,\"InsertTrackBasicWeight\":0,\"InsertTrackProofSize\":0,\"InsertTrackRefTime\":0,\"SupportedClient\":0,\"WaitingSecondsForWatcherTx\":0,\"WaitingForResult\":false}", smartContract.ExtraInfo);
