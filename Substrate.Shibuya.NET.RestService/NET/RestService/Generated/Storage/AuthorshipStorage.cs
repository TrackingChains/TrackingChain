...
namespace Substrate.Shibuya.NET.RestService.Generated.Storage
{
    ...
    public interface IAuthorshipStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetAuthor();
    }
    ...
    public sealed class AuthorshipStorage : IAuthorshipStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> _authorTypedStorage;
        ...
        {
            this.AuthorTypedStorage = new TypedStorage<Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>("Authorship.Author", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _authorTypedStorage property
        /// </summary>
        public TypedStorage<Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> AuthorTypedStorage
        {
            get
            {
        ...
        ///  Author of current block.
        /// </summary>
        public Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetAuthor()
        {
