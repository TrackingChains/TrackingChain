...
namespace Substrate.Shibuya.NET.RestService.Generated.Storage
{
    ...
    public interface ISudoStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetKey();
    }
    ...
    public sealed class SudoStorage : ISudoStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> _keyTypedStorage;
        ...
        {
            this.KeyTypedStorage = new TypedStorage<Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>("Sudo.Key", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _keyTypedStorage property
        /// </summary>
        public TypedStorage<Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> KeyTypedStorage
        {
            get
            {
        ...
        ///  The `AccountId` of the sudo key.
        /// </summary>
        public Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetKey()
        {
