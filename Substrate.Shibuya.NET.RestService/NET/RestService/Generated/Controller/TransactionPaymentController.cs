...
namespace Substrate.Shibuya.NET.RestService.Generated.Controller
{
    ...
    public sealed class TransactionPaymentController : ControllerBase
    {
        ...
        [ProducesResponseType(typeof(Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128), 200)]
        [StorageKeyBuilder(typeof(Substrate.Shibuya.NET.NetApiExt.Generated.Storage.TransactionPaymentStorage), "NextFeeMultiplierParams")]
        ...
        [ProducesResponseType(typeof(Substrate.Shibuya.NET.NetApiExt.Generated.Model.pallet_transaction_payment.EnumReleases), 200)]
        [StorageKeyBuilder(typeof(Substrate.Shibuya.NET.NetApiExt.Generated.Storage.TransactionPaymentStorage), "StorageVersionParams")]
