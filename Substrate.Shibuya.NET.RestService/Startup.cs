...
using Substrate.Shibuya.NET.RestService.Formatters;
...
namespace Substrate.Shibuya.NET.RestService
{
   ...
   public class Startup
   {
      ...
      public void ConfigureServices(IServiceCollection services)
      {
         ...
         else
         {
            ...
            _storageDataProvider = new SubstrateDataProvider(Environment.GetEnvironmentVariable("SUBSTRATE_WEBSOCKET_ENDPOINT") ?? "wss://shibuya.blastapi.io/8508719b-69eb-4c01-92e4-eb902da0fb97");
         }
         ...
         services.AddSwaggerGen(c =>
         {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "Substrate.Shibuya.NET.RestService", Version = "v1" });
         });
      }
      ...
      public void Configure(IApplicationBuilder app, IWebHostEnvironment env, StorageSubscriptionHandler handler)
      {
         ...
         app.UseSwaggerUI(
             c =>
             {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Substrate.Shibuya.NET.RestService v1");
             }
         );
