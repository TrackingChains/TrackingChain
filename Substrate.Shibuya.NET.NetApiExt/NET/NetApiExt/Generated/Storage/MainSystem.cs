...
namespace Substrate.Shibuya.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class SystemStorage
    {
        ...
        public SystemStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "Account"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32), typeof(Substrate.Shibuya.NET.NetApiExt.Generated.Model.frame_system.AccountInfo)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "BlockWeight"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Shibuya.NET.NetApiExt.Generated.Model.frame_support.dispatch.PerDispatchClassT1)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "BlockHash"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.Shibuya.NET.NetApiExt.Generated.Model.primitive_types.H256)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "ParentHash"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Shibuya.NET.NetApiExt.Generated.Model.primitive_types.H256)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "Digest"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "Events"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Shibuya.NET.NetApiExt.Generated.Model.frame_system.EventRecord>)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "LastRuntimeUpgrade"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Shibuya.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "ExecutionPhase"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Shibuya.NET.NetApiExt.Generated.Model.frame_system.EnumPhase)));
        }
        ...
        /// </summary>
        public static string AccountParams(Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  The full account information for a particular account ID.
        /// </summary>
        public async Task<Substrate.Shibuya.NET.NetApiExt.Generated.Model.frame_system.AccountInfo> Account(Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = SystemStorage.AccountParams(key);
            var result = await _client.GetStorageAsync<Substrate.Shibuya.NET.NetApiExt.Generated.Model.frame_system.AccountInfo>(parameters, token);
            return result;
        }
        ...
        ///  The current weight for the block.
        /// </summary>
        public async Task<Substrate.Shibuya.NET.NetApiExt.Generated.Model.frame_support.dispatch.PerDispatchClassT1> BlockWeight(CancellationToken token)
        {
            string parameters = SystemStorage.BlockWeightParams();
            var result = await _client.GetStorageAsync<Substrate.Shibuya.NET.NetApiExt.Generated.Model.frame_support.dispatch.PerDispatchClassT1>(parameters, token);
            return result;
        }
        ...
        ///  Map of block numbers to block hashes.
        /// </summary>
        public async Task<Substrate.Shibuya.NET.NetApiExt.Generated.Model.primitive_types.H256> BlockHash(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
        ...
        ///  Hash of the previous block.
        /// </summary>
        public async Task<Substrate.Shibuya.NET.NetApiExt.Generated.Model.primitive_types.H256> ParentHash(CancellationToken token)
        {
        ...
        ///  Digest of the current block, also part of the block header.
        /// </summary>
        public async Task<Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest> Digest(CancellationToken token)
        {
            string parameters = SystemStorage.DigestParams();
            var result = await _client.GetStorageAsync<Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest>(parameters, token);
            return result;
        }
        ...
        ///  just in case someone still reads them from within the runtime.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Shibuya.NET.NetApiExt.Generated.Model.frame_system.EventRecord>> Events(CancellationToken token)
        {
            string parameters = SystemStorage.EventsParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Shibuya.NET.NetApiExt.Generated.Model.frame_system.EventRecord>>(parameters, token);
            return result;
        }
        ...
        /// </summary>
        public static string EventTopicsParams(Substrate.Shibuya.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  no notification will be triggered thus the event might be lost.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32>>> EventTopics(Substrate.Shibuya.NET.NetApiExt.Generated.Model.primitive_types.H256 key, CancellationToken token)
        {
        ...
        ///  Stores the `spec_version` and `spec_name` of when the last runtime upgrade happened.
        /// </summary>
        public async Task<Substrate.Shibuya.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo> LastRuntimeUpgrade(CancellationToken token)
        {
            string parameters = SystemStorage.LastRuntimeUpgradeParams();
            var result = await _client.GetStorageAsync<Substrate.Shibuya.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo>(parameters, token);
            return result;
        }
        ...
        ///  The execution phase of the block.
        /// </summary>
        public async Task<Substrate.Shibuya.NET.NetApiExt.Generated.Model.frame_system.EnumPhase> ExecutionPhase(CancellationToken token)
        {
            string parameters = SystemStorage.ExecutionPhaseParams();
            var result = await _client.GetStorageAsync<Substrate.Shibuya.NET.NetApiExt.Generated.Model.frame_system.EnumPhase>(parameters, token);
            return result;
        }
    }
    ...
    public sealed class SystemCalls
    {
        ...
        public static Method Remark(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8> remark)
        {
            ...
            return new Method(10, "System", 0, "remark", byteArray.ToArray());
        }
        ...
        public static Method SetHeapPages(Substrate.NetApi.Model.Types.Primitive.U64 pages)
        {
            ...
            return new Method(10, "System", 1, "set_heap_pages", byteArray.ToArray());
        }
        ...
        public static Method SetCode(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8> code)
        {
            ...
            return new Method(10, "System", 2, "set_code", byteArray.ToArray());
        }
        ...
        public static Method SetCodeWithoutChecks(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8> code)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(code.Encode());
            return new Method(10, "System", 3, "set_code_without_checks", byteArray.ToArray());
        }
        ...
        public static Method SetStorage(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>>> items)
        {
            ...
            return new Method(10, "System", 4, "set_storage", byteArray.ToArray());
        }
        ...
        public static Method KillStorage(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>> keys)
        {
            ...
            return new Method(10, "System", 5, "kill_storage", byteArray.ToArray());
        }
        ...
        public static Method KillPrefix(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8> prefix, Substrate.NetApi.Model.Types.Primitive.U32 subkeys)
        {
            ...
            return new Method(10, "System", 6, "kill_prefix", byteArray.ToArray());
        }
        ...
        public static Method RemarkWithEvent(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8> remark)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(remark.Encode());
            return new Method(10, "System", 7, "remark_with_event", byteArray.ToArray());
        }
    }
    ...
    public sealed class SystemConstants
    {
        ...
        /// </summary>
        public Substrate.Shibuya.NET.NetApiExt.Generated.Model.frame_system.limits.BlockWeights BlockWeights()
        {
            var result = new Substrate.Shibuya.NET.NetApiExt.Generated.Model.frame_system.limits.BlockWeights();
            result.Create("0x624FD75A00070088526A740200400102C0CD1700010700028FA54B0200D000010700E6BD4F57020" +
                    "0F00001000002C0CD1700010700A423C0680200200101070088526A7402004001010700A2941A1D0" +
                    "200500002C0CD1700000000");
            return result;
        }
        ...
        /// </summary>
        public Substrate.Shibuya.NET.NetApiExt.Generated.Model.frame_system.limits.BlockLength BlockLength()
        {
            var result = new Substrate.Shibuya.NET.NetApiExt.Generated.Model.frame_system.limits.BlockLength();
        ...
        /// </summary>
        public Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_weights.RuntimeDbWeight DbWeight()
        {
            var result = new Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_weights.RuntimeDbWeight();
        ...
        /// </summary>
        public Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_version.RuntimeVersion Version()
        {
            var result = new Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_version.RuntimeVersion();
            result.Create(@"");
            return result;
        }
