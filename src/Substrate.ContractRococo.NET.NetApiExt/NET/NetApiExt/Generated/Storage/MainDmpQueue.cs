...
namespace Substrate.ContractRococo.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class DmpQueueStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("DmpQueue", "Configuration"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.ContractRococo.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.ConfigData)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("DmpQueue", "PageIndex"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.ContractRococo.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.PageIndexData)));
        ...
        ///  The configuration.
        /// </summary>
        public async Task<Substrate.ContractRococo.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.ConfigData> Configuration(CancellationToken token)
        {
            string parameters = DmpQueueStorage.ConfigurationParams();
            var result = await _client.GetStorageAsync<Substrate.ContractRococo.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.ConfigData>(parameters, token);
            return result;
        }
        ...
        ///  The page index.
        /// </summary>
        public async Task<Substrate.ContractRococo.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.PageIndexData> PageIndex(CancellationToken token)
        {
            string parameters = DmpQueueStorage.PageIndexParams();
            var result = await _client.GetStorageAsync<Substrate.ContractRococo.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.PageIndexData>(parameters, token);
            return result;
        }
