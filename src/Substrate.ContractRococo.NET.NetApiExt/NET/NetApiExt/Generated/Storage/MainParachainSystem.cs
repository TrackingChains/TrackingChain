...
namespace Substrate.ContractRococo.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class ParachainSystemStorage
    {
        ...
        public ParachainSystemStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "ValidationData"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.ContractRococo.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.PersistedValidationData)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "UpgradeRestrictionSignal"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.ContractRococo.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.EnumUpgradeRestriction>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "RelayStateProof"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.ContractRococo.NET.NetApiExt.Generated.Model.sp_trie.storage_proof.StorageProof)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "RelevantMessagingState"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.ContractRococo.NET.NetApiExt.Generated.Model.cumulus_pallet_parachain_system.relay_state_snapshot.MessagingStateSnapshot)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "HostConfiguration"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.ContractRococo.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.AbridgedHostConfiguration)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "LastDmqMqcHead"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.ContractRococo.NET.NetApiExt.Generated.Model.cumulus_primitives_parachain_inherent.MessageQueueChain)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "LastHrmpMqcHeads"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.ContractRococo.NET.NetApiExt.Generated.Types.Base.BTreeMapT1)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "ReservedXcmpWeightOverride"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.ContractRococo.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "ReservedDmpWeightOverride"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.ContractRococo.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "AuthorizedUpgrade"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.ContractRococo.NET.NetApiExt.Generated.Model.cumulus_pallet_parachain_system.CodeUpgradeAuthorization)));
        ...
        ///  in the trie.
        /// </summary>
        public async Task<Substrate.ContractRococo.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.PersistedValidationData> ValidationData(CancellationToken token)
        {
            string parameters = ParachainSystemStorage.ValidationDataParams();
            var result = await _client.GetStorageAsync<Substrate.ContractRococo.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.PersistedValidationData>(parameters, token);
            return result;
        }
        ...
        ///  set after the inherent.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.ContractRococo.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.EnumUpgradeRestriction>> UpgradeRestrictionSignal(CancellationToken token)
        {
            string parameters = ParachainSystemStorage.UpgradeRestrictionSignalParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.ContractRococo.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.EnumUpgradeRestriction>>(parameters, token);
            return result;
        }
        ...
        ///  This data is also absent from the genesis.
        /// </summary>
        public async Task<Substrate.ContractRococo.NET.NetApiExt.Generated.Model.sp_trie.storage_proof.StorageProof> RelayStateProof(CancellationToken token)
        {
            string parameters = ParachainSystemStorage.RelayStateProofParams();
            var result = await _client.GetStorageAsync<Substrate.ContractRococo.NET.NetApiExt.Generated.Model.sp_trie.storage_proof.StorageProof>(parameters, token);
            return result;
        }
        ...
        ///  This data is also absent from the genesis.
        /// </summary>
        public async Task<Substrate.ContractRococo.NET.NetApiExt.Generated.Model.cumulus_pallet_parachain_system.relay_state_snapshot.MessagingStateSnapshot> RelevantMessagingState(CancellationToken token)
        {
            string parameters = ParachainSystemStorage.RelevantMessagingStateParams();
            var result = await _client.GetStorageAsync<Substrate.ContractRococo.NET.NetApiExt.Generated.Model.cumulus_pallet_parachain_system.relay_state_snapshot.MessagingStateSnapshot>(parameters, token);
            return result;
        }
        ...
        ///  This data is also absent from the genesis.
        /// </summary>
        public async Task<Substrate.ContractRococo.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.AbridgedHostConfiguration> HostConfiguration(CancellationToken token)
        {
            string parameters = ParachainSystemStorage.HostConfigurationParams();
            var result = await _client.GetStorageAsync<Substrate.ContractRococo.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.AbridgedHostConfiguration>(parameters, token);
            return result;
        }
        ...
        ///  by the system inherent.
        /// </summary>
        public async Task<Substrate.ContractRococo.NET.NetApiExt.Generated.Model.cumulus_primitives_parachain_inherent.MessageQueueChain> LastDmqMqcHead(CancellationToken token)
        {
            string parameters = ParachainSystemStorage.LastDmqMqcHeadParams();
            var result = await _client.GetStorageAsync<Substrate.ContractRococo.NET.NetApiExt.Generated.Model.cumulus_primitives_parachain_inherent.MessageQueueChain>(parameters, token);
            return result;
        }
        ...
        ///  by the system inherent.
        /// </summary>
        public async Task<Substrate.ContractRococo.NET.NetApiExt.Generated.Types.Base.BTreeMapT1> LastHrmpMqcHeads(CancellationToken token)
        {
            string parameters = ParachainSystemStorage.LastHrmpMqcHeadsParams();
            var result = await _client.GetStorageAsync<Substrate.ContractRococo.NET.NetApiExt.Generated.Types.Base.BTreeMapT1>(parameters, token);
            return result;
        }
        ...
        ///  This will be cleared in `on_initialize` of each new block.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.ContractRococo.NET.NetApiExt.Generated.Model.polkadot_core_primitives.OutboundHrmpMessage>> HrmpOutboundMessages(CancellationToken token)
        {
            string parameters = ParachainSystemStorage.HrmpOutboundMessagesParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.ContractRococo.NET.NetApiExt.Generated.Model.polkadot_core_primitives.OutboundHrmpMessage>>(parameters, token);
            return result;
        }
        ...
        ///  overrides the amount set in the Config trait.
        /// </summary>
        public async Task<Substrate.ContractRococo.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight> ReservedXcmpWeightOverride(CancellationToken token)
        {
            string parameters = ParachainSystemStorage.ReservedXcmpWeightOverrideParams();
            var result = await _client.GetStorageAsync<Substrate.ContractRococo.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight>(parameters, token);
            return result;
        }
        ...
        ///  overrides the amount set in the Config trait.
        /// </summary>
        public async Task<Substrate.ContractRococo.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight> ReservedDmpWeightOverride(CancellationToken token)
        {
        ...
        ///  The next authorized upgrade, if there is one.
        /// </summary>
        public async Task<Substrate.ContractRococo.NET.NetApiExt.Generated.Model.cumulus_pallet_parachain_system.CodeUpgradeAuthorization> AuthorizedUpgrade(CancellationToken token)
        {
            string parameters = ParachainSystemStorage.AuthorizedUpgradeParams();
            var result = await _client.GetStorageAsync<Substrate.ContractRococo.NET.NetApiExt.Generated.Model.cumulus_pallet_parachain_system.CodeUpgradeAuthorization>(parameters, token);
            return result;
        }
    ...
    public sealed class ParachainSystemCalls
    {
        ...
        /// </summary>
        public static Method SetValidationData(Substrate.ContractRococo.NET.NetApiExt.Generated.Model.cumulus_primitives_parachain_inherent.ParachainInherentData data)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method AuthorizeUpgrade(Substrate.ContractRococo.NET.NetApiExt.Generated.Model.primitive_types.H256 code_hash, Substrate.NetApi.Model.Types.Primitive.Bool check_version)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
