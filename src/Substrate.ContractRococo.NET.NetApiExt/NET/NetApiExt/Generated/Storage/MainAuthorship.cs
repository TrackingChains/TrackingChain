...
namespace Substrate.ContractRococo.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class AuthorshipStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Authorship", "Author"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.ContractRococo.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32)));
        }
        ...
        ///  Author of current block.
        /// </summary>
        public async Task<Substrate.ContractRococo.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> Author(CancellationToken token)
        {
