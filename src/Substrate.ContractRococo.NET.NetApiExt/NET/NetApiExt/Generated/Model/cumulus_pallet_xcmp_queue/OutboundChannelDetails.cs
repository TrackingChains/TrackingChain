...
namespace Substrate.ContractRococo.NET.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue
{
    ...
    /// <summary>
    /// >> 211 - Composite[cumulus_pallet_xcmp_queue.OutboundChannelDetails]
    /// </summary>
    ...
    public sealed class OutboundChannelDetails : BaseType
    {
        ...
        /// >> recipient
        /// </summary>
        private Substrate.ContractRococo.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id _recipient;
        
        /// <summary>
        /// >> state
        /// </summary>
        private Substrate.ContractRococo.NET.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue.EnumOutboundState _state;
        ...
        public Substrate.ContractRococo.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id Recipient
        {
            get
            {
        ...
        public Substrate.ContractRococo.NET.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue.EnumOutboundState State
        {
            get
            {
                return this._state;
        ...
        {
            var start = p;
            Recipient = new Substrate.ContractRococo.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id();
            Recipient.Decode(byteArray, ref p);
            State = new Substrate.ContractRococo.NET.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue.EnumOutboundState();
