...
namespace Substrate.ContractRococo.NET.NetApiExt.Generated.Model.pallet_contracts.wasm
{
    
    
    /// <summary>
    /// >> 270 - Composite[pallet_contracts.wasm.PrefabWasmModule]
    /// </summary>
    ...
    public sealed class PrefabWasmModule : BaseType
    {
        ...
        /// >> code
        /// </summary>
        private Substrate.ContractRococo.NET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT3 _code;
        
        /// <summary>
        /// >> determinism
        /// </summary>
        private Substrate.ContractRococo.NET.NetApiExt.Generated.Model.pallet_contracts.wasm.EnumDeterminism _determinism;
        ...
        public Substrate.ContractRococo.NET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT3 Code
        {
            get
            {
                return this._code;
        ...
        public Substrate.ContractRococo.NET.NetApiExt.Generated.Model.pallet_contracts.wasm.EnumDeterminism Determinism
        {
            get
            {
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            Code = new Substrate.ContractRococo.NET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT3();
            Code.Decode(byteArray, ref p);
            Determinism = new Substrate.ContractRococo.NET.NetApiExt.Generated.Model.pallet_contracts.wasm.EnumDeterminism();
