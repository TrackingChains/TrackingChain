...
namespace Substrate.ContractRococo.NET.NetApiExt.Generated.Model.pallet_contracts.wasm
{
    ...
    /// <summary>
    /// >> 273 - Composite[pallet_contracts.wasm.OwnerInfo]
    /// </summary>
    ...
    public sealed class OwnerInfo : BaseType
    {
        ...
        /// >> owner
        /// </summary>
        private Substrate.ContractRococo.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 _owner;
        ...
        public Substrate.ContractRococo.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 Owner
        {
            get
            {
                return this._owner;
        ...
        {
            var start = p;
            Owner = new Substrate.ContractRococo.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
