...
namespace Substrate.ContractRococo.NET.NetApiExt.Generated.Model.polkadot_primitives.v4
{
    
    
    /// <summary>
    /// >> 132 - Composite[polkadot_primitives.v4.PersistedValidationData]
    /// </summary>
    ...
    public sealed class PersistedValidationData : BaseType
    {
        ...
        /// >> parent_head
        /// </summary>
        private Substrate.ContractRococo.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.HeadData _parentHead;
        ...
        /// </summary>
        private Substrate.ContractRococo.NET.NetApiExt.Generated.Model.primitive_types.H256 _relayParentStorageRoot;
        ...
        public Substrate.ContractRococo.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.HeadData ParentHead
        {
            get
            {
        ...
        public Substrate.ContractRococo.NET.NetApiExt.Generated.Model.primitive_types.H256 RelayParentStorageRoot
        {
            get
            {
        ...
        {
            var start = p;
            ParentHead = new Substrate.ContractRococo.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.HeadData();
            ...
            RelayParentStorageRoot = new Substrate.ContractRococo.NET.NetApiExt.Generated.Model.primitive_types.H256();
