...
namespace TrackingChain.TriageAPI.Controllers
{
    ...
    public class AnalyticController : ControllerBase
    {
        ...
        [HttpGet("Analytic/Tracking/{trackingId}")]
        ...
        [HttpGet("Analytic/Tracking/Failed/{size}/{page}")]
        [ProducesResponseType(typeof(string), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(string), StatusCodes.Status500InternalServerError)]
        ...
        [HttpGet("Analytic/Tracking/Successfully/{size}/{page}")]
        [ProducesResponseType(typeof(string), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(string), StatusCodes.Status500InternalServerError)]
        ...
        [HttpGet("Analytic/Tracking/Pools/{size}/{page}")]
        [ProducesResponseType(typeof(string), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(string), StatusCodes.Status500InternalServerError)]
        ...
        [HttpGet("Analytic/Tracking/Pendings/{size}/{page}")]
        [ProducesResponseType(typeof(string), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(string), StatusCodes.Status500InternalServerError)]
        ...
        [HttpGet("Analytic/Tracking/Triages/{size}/{page}")]
        [ProducesResponseType(typeof(string), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(string), StatusCodes.Status500InternalServerError)]
