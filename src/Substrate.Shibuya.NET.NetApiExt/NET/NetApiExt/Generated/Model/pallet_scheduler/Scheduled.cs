...
namespace Substrate.Shibuya.NET.NetApiExt.Generated.Model.pallet_scheduler
{
    
    
    /// <summary>
    /// >> 351 - Composite[pallet_scheduler.Scheduled]
    /// </summary>
    ...
    public sealed class Scheduled : BaseType
    {
        ...
        /// >> maybe_id
        /// </summary>
        private Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Shibuya.NET.NetApiExt.Generated.Types.Base.Arr32U8> _maybeId;
        ...
        /// >> call
        /// </summary>
        private Substrate.Shibuya.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded _call;
        ...
        /// >> origin
        /// </summary>
        private Substrate.Shibuya.NET.NetApiExt.Generated.Model.shibuya_runtime.EnumOriginCaller _origin;
        
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Shibuya.NET.NetApiExt.Generated.Types.Base.Arr32U8> MaybeId
        {
            get
            {
        ...
        public Substrate.Shibuya.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded Call
        {
            get
            {
                return this._call;
        ...
        public Substrate.Shibuya.NET.NetApiExt.Generated.Model.shibuya_runtime.EnumOriginCaller Origin
        {
            get
            {
                return this._origin;
        ...
        {
            var start = p;
            MaybeId = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Shibuya.NET.NetApiExt.Generated.Types.Base.Arr32U8>();
            MaybeId.Decode(byteArray, ref p);
            Priority = new Substrate.NetApi.Model.Types.Primitive.U8();
            Priority.Decode(byteArray, ref p);
            Call = new Substrate.Shibuya.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded();
            ...
            Origin = new Substrate.Shibuya.NET.NetApiExt.Generated.Model.shibuya_runtime.EnumOriginCaller();
