...
namespace Substrate.Shibuya.NET.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue
{
    ...
    /// <summary>
    /// >> 439 - Composite[cumulus_pallet_xcmp_queue.OutboundChannelDetails]
    /// </summary>
    ...
    public sealed class OutboundChannelDetails : BaseType
    {
        ...
        /// >> recipient
        /// </summary>
        private Substrate.Shibuya.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id _recipient;
        
        /// <summary>
        /// >> state
        /// </summary>
        private Substrate.Shibuya.NET.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue.EnumOutboundState _state;
        ...
        public Substrate.Shibuya.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id Recipient
        {
            get
            {
        ...
        public Substrate.Shibuya.NET.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue.EnumOutboundState State
        {
            get
            {
                return this._state;
        ...
        {
            var start = p;
            Recipient = new Substrate.Shibuya.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id();
            Recipient.Decode(byteArray, ref p);
            State = new Substrate.Shibuya.NET.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue.EnumOutboundState();
